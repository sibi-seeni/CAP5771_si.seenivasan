...
I designed the database is designed using a Relational Schema (SQLAlchemy) to ensure data integrity and minimize redundancy.
...
* **State Tracking:** The 'CollectionState' table operates independently to track the 'last_search_time' for specific keywords, facilitating incremental data updates and pulls.
